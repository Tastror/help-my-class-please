...
def click(x=None, y=None, clicks=1, interval=0.0, duration=0.0, logScreenshot=None, _pause=True):
    pag.click(
        x=x, y=y, clicks=clicks, interval=interval, duration=duration,
